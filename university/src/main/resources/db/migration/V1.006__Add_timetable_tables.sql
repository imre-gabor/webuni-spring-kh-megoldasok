...
alter table course add column semester_type int4 default 0, add column year int4 not null default 2022;
alter table course_aud add column semester_type int4 default 0, add column year int4 not null default 2022;
